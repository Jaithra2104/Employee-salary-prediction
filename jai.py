...
# -------------------------------
# 🔽 Google Drive File IDs (NEW)
# -------------------------------
MODEL_FILE_ID = "1zgWrSbYd9Sh6Ljmco_XZeDFvXbxhCXnd"       # salary_model.pkl
ENCODER_FILE_ID = "1nNeglxfpXomm7CNjECWBpJphyMLAwTpj"     # encoders.pkl

# -------------------------------
# 🔽 Download model and encoder using gdown
# -------------------------------
...
if not os.path.exists("salary_model.pkl"):
    download_from_gdrive(MODEL_FILE_ID, "salary_model.pkl")

if not os.path.exists("encoders.pkl"):
    download_from_gdrive(ENCODER_FILE_ID, "encoders.pkl")
...
# -------------------------------
st.markdown("""
    <div style="background-color: #1e3a8a; padding: 1rem 2rem; border-radius: 0 0 12px 12px; 
                box-shadow: 0 4px 20px rgba(30, 64, 175, 0.4); margin-bottom: 20px;">
        <h3 style="color: #ffffff; margin: 0;">
            🔗 View Full Project on 
            <a href="https://github.com/Jaithra2104/Employee-salary-prediction.git" target="_blank" style="color: #38bdf8; text-decoration: none;">
                GitHub
            </a>
        </h3>
    </div>
